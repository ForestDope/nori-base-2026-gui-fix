...
TEST_SCENES = [
    "pa3/tests/test-mesh.xml",
    "pa3/tests/test-mesh-furnace.xml",
    "pa4/tests/chi2test-microfacet.xml",
    "pa4/tests/ttest-microfacet.xml",
    "pa4/tests/test-direct.xml",
    "pa4/tests/test-furnace.xml",
]
